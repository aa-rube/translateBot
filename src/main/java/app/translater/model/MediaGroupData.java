...
public class MediaGroupData {
    private final List<String> listPhotoFilesId = new ArrayList<>();
    private final List<String> listVideoFilesId = new ArrayList<>();
    private final List<String> listDocumentsFilesId = new ArrayList<>();
    private final List<String> listAudioFilesId = new ArrayList<>();
